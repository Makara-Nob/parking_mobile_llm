 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "!pip install -q -U torch transformers accelerate bitsandbytes langchain langchain-community sentence-transformers chromadb pypdf unstructured networkx"
   ]
  },
  {
   "cell_type": "code",
...
with open("rag_pipeline_demo.ipynb", "w") as f:
